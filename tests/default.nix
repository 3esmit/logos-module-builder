...
let
  ...
  externalLibTests = import ./test-external-lib.nix { inherit assertEq assertBool assertThrows mkExternalLib; };
  ...
  suites = [
    ...
    { name = "test-composed-module-deps"; tests = composedDepsTests; }
    ...
    { name = "test-host-codegen";          tests = hostCodegenTests; }
  ];
